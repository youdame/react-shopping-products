...
function ModalMain({ isOpen, size, onClose, position: position2, children }) {
  useEscKeydown(onClose);
  useScrollBlock(isOpen);
  if (!isOpen)
    return null;
  return /* @__PURE__ */ jsx$1(ModalPortal, { children: /* @__PURE__ */ jsx$1(ModalContext.Provider, { value: { onClose, position: position2, size }, children }) });
}
...
function CartModal({ isOpen, onClose, title, content, footer }) {
...
function HomeHeader() {
  ...
  const cartLength = cartItems == null ? void 0 : cartItems.content.length;
  ...
  const totalPrice = cartItems == null ? void 0 : cartItems.content.reduce((acc, item) => acc + item.quantity * item.product.price, 0);
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx$1(
      Header,
      {
    ...
    isAlertOpen && (cartItems == null ? void 0 : cartItems.content) && /* @__PURE__ */ jsx$1(
      CartModal,
      {
        isOpen: isAlertOpen,
        onClose: () => setAlertOpen(false),
        title: "장바구니",
        content: /* @__PURE__ */ jsx$1("div", { css: modalContent, children: /* @__PURE__ */ jsx$1(CartList, { cartItems: cartItems == null ? void 0 : cartItems.content, onClick: handleDeleteCart }) }),
  ...
  return /* @__PURE__ */ jsxs("div", { css: wrapperStyle, ref, children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        type: "button",
        autoFocus: value === "",
        css: [selectBoxStyle, isOpen && openStyle, value ? selectedStyle : unSelectedStyle],
    ...
    isOpen && /* @__PURE__ */ jsx$1("ul", { css: listStyle, children: list.map((item) => /* @__PURE__ */ jsx$1("li", { css: itemStyle, onClick: () => handleSelect(item), children: item }, item)) })
  ] });
}
...
function createProductListViewModel({
  ...
  return products.map((product) => {
    const matchedCart = cartItems == null ? void 0 : cartItems.find((item) => item.product.id === product.id);
    return {
      id: product.id,
      title: product.name,
...
function ProductList() {
  ...
  const { data: cartItems, fetcher: refetchCart } = useApiContext({
    fetchFn: getCartItems,
    key: "getCartItems"
  });
  const filteredProducts = category === "전체" ? products == null ? void 0 : products.content : products == null ? void 0 : products.content.filter((item) => item.category === category);
...
async function enableMocking() {
  const { worker } = await __vitePreload(() => import("./browser-Ct2fR79E.js"), true ? [] : void 0);
