...
function useFetch(url, options = {}, immediate = true, deps = []) {
...
function useProductQuery(orderBy) {
...
function useOutsideClick(onClickOutside) {
...
function Dropdown({
  ...
  const handleToggle = () => setIsOpen((prev2) => !prev2);
  const ref = useOutsideClick(() => setIsOpen(false));
  const handleSelect = (item) => {
    onSelect(item);
    setIsOpen(false);
  };
  return /* @__PURE__ */ jsxs("div", { css: wrapperStyle, ref, children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        type: "button",
        ...
        css: [
          selectBoxStyle,
          isOpen && openStyle,
          value ? selectedStyle : unSelectedStyle
        ],
        onClick: handleToggle,
        children: [
          value || placeholder,
          /* @__PURE__ */ jsx$1("img", { src: "assets/dropdownArrow.svg" })
        ]
      }
    ),
    isOpen && /* @__PURE__ */ jsx$1("ul", { css: listStyle, children: list.map((item) => /* @__PURE__ */ jsx$1(
      "li",
      {
        css: itemStyle,
...
const CartContextProvider = ({ children }) => {
  const [cartLength, cartLengthSetter] = reactExports.useState(null);
  const setCartLength = reactExports.useCallback((length2) => {
    cartLengthSetter(length2);
  }, []);
  return /* @__PURE__ */ jsx$1(CartContext.Provider, { value: { cartLength, setCartLength }, children });
};
const useCartContext = () => {
  const cartContext = reactExports.useContext(CartContext);
  if (cartContext === void 0) {
...
const Spinner = ({ size = "medium" }) => {
  return /* @__PURE__ */ jsx$1("div", { css: containerStyle, children: /* @__PURE__ */ jsx$1(
    "div",
    {
      css: [
        baseSpinnerStyle,
...
function CartButton({
  ...
  const { cartLength } = useCartContext();
  const [isFetchLoading, setIsFetchLoading] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsx$1(
    "button",
    {
      ...
      css: [
        buttonCss,
        isInCart ? inCartCss : notInCartCss
      ],
      children: isInCart ? /* @__PURE__ */ jsxs(Fragment, { children: [
...
function ProductCard({
  ...
  return /* @__PURE__ */ jsxs("li", { css: cardCss, children: [
    ...
    /* @__PURE__ */ jsxs("div", { css: detailCss, children: [
      ...
      /* @__PURE__ */ jsx$1("p", { children: `${price.toLocaleString()}원` }),
      /* @__PURE__ */ jsx$1(
        CartButton,
        {
          productId,
...
function ProductList({
  ...
  return /* @__PURE__ */ jsx$1("ul", { css: listCss, children: products == null ? void 0 : products.map(({ id: id2, price, name, imageUrl }) => {
    var _a;
    return /* @__PURE__ */ jsx$1(
      ProductCard,
      {
        productId: id2,
        cartItemId: (_a = cartItems == null ? void 0 : cartItems.find((cartItem) => cartItem.product.id === id2)) == null ? void 0 : _a.id,
        price,
        title: name,
        imageUrl,
        refetchCart,
        isItemInCart: Boolean(cartItems == null ? void 0 : cartItems.some((p2) => p2.product.id === id2))
      },
      id2
    );
  }) });
...
function App() {
  ...
  } = useFetch(useProductQuery(orderBy));
  const {
    data: cartItems,
    fetcher: refetchCart,
  ...
  }, [(_a = cartItems == null ? void 0 : cartItems.content) == null ? void 0 : _a.length]);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxs("div", { css: bodyCss, children: [
    ...
    /* @__PURE__ */ jsxs("div", { css: dropdownDivCss, children: [
    ...
    productFetchLoading ? /* @__PURE__ */ jsx$1("div", { style: { marginBottom: "500px" }, children: /* @__PURE__ */ jsx$1(Spinner, { size: "medium" }) }) : /* @__PURE__ */ jsx$1(
      ProductList,
      {
        products: category === "전체" ? products == null ? void 0 : products.content : products == null ? void 0 : products.content.filter((item) => item.category == category),
        cartItems: cartItems == null ? void 0 : cartItems.content,
...
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsx$1(React.StrictMode, { children: /* @__PURE__ */ jsx$1(ErrorContextProvider, { children: /* @__PURE__ */ jsx$1(CartContextProvider, { children: /* @__PURE__ */ jsx$1(App, {}) }) }) })
);
